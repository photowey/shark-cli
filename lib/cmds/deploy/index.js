...
async function deploy(config) {
    ...
    console.log(chalk.green('Parse [%s] successfully!'), name)
    console.log(chalk.yellow('Handle the cmd:[%s], the options::branch:[%s];env:[%s];machineRoom:[%s]'), name, branch, env, machineRoom)
